...
use palomadex::asset::{native_asset_info, AssetInfo};
...
fn proper_initialization() {
    ...
    let msg = InstantiateMsg {
        palomadex_factory: String::from("palomadexfactory"),
    };
    ...
    assert_eq!("palomadexfactory", config.palomadex_factory.as_str());
}
...
fn execute_swap_operation() {
    ...
    deps.querier
        .with_palomadex_pairs(&[(&"uusdasset".to_string(), &String::from("pair"))]);
    ...
    deps.querier
        .with_palomadex_pairs(&[(&"assetuusd".to_string(), &String::from("pair"))]);
        ...
        vec![SubMsg {
            msg: WasmMsg::Execute {
                ...
                msg: to_json_binary(&Cw20ExecuteMsg::Send {
                    ...
                    amount: Uint128::new(1000000u128),
                    msg: to_json_binary(&palomadex::pair::Cw20HookMsg::Swap {
