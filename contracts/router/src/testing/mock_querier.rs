...
use palomadex::pair::SimulationResponse;
...
impl WasmMockQuerier {
    ...
    pub fn with_palomadex_pairs(&mut self, pairs: &[(&String, &String)]) {
        self.palomadex_factory_querier = PalomadexFactoryQuerier::new(pairs);
    }
}
